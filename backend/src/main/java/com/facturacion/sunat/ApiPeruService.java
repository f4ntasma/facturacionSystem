...
public class ApiPeruService {
    ...
    public Map<String, Object> consultarDni(String dni) {
        try {
            ...
            return response.getBody() != null ? response.getBody()
                    : Map.of("success", false, "message", "Sin respuesta del servicio");
        } catch (Exception e) {
            return Map.of("success", false, "message", "DNI no encontrado o servicio no disponible");
        }
    }
    ...
    public Map<String, Object> consultarRuc(String ruc) {
        try {
            ...
            return Map.of("success", false, "message", "RUC no encontrado o servicio no disponible");
        }
    }
}
