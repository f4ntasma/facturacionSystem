    ...
    <div style="min-height: 100vh; background: linear-gradient(135deg, #1e3a8a, #7c3aed);
      ...
      <div style="background: white; border-radius: 1.5rem; padding: 2.5rem;
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem;">
          ...
          <div style="display: flex; align-items: flex-start; gap: 0.6rem; margin-top: 0.25rem;">
            <input type="checkbox" [(ngModel)]="aceptaTerminos" name="aceptaTerminos" id="terminos-reg"
                   style="margin-top: 2px; cursor: pointer; accent-color: #7c3aed;">
            <label for="terminos-reg" style="font-size: 12.5px; color: #4b5563; cursor: pointer; line-height: 1.5;">
              He leido y acepto los
              <a href="/terminos" target="_blank" style="color: #7c3aed; font-weight: 600;">Terminos y Condiciones</a>
              y la
              <a href="/privacidad" target="_blank" style="color: #7c3aed; font-weight: 600;">Politica de Privacidad</a>
              de Factullama.
            </label>
          </div>
        </div>

        <button (click)="registrar()" [disabled]="loading || !aceptaTerminos"
...
export class RegistroComponent {
  ...
  registrar() {
    if (!this.aceptaTerminos) {
      this.error = 'Debes aceptar los Terminos y Condiciones para continuar';
      return;
    }
