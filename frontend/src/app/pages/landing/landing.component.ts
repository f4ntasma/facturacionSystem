...
export class LandingComponent {
  ...
  faqs = [
    ...
    },
    {
      ...
      respuesta: 'Si. Ofrecemos un periodo de prueba gratuito de 3 dias con acceso completo al sistema, sin necesidad de tarjeta de credito. Haz clic en "Comenzar Gratis Hoy" para activarlo.',
      abierto: false
    },
    {
